...
qBar = np.array([0 , np.pi]) # Desired configuration
...
trep.forces.ConfigForce(system, 'yc', 'cart-force') # Add input
...
xIndex = dsys.system.get_config('yc').index
...
dsys.set(np.array([0.,q0,0.,0.]), np.array([0.]), 0)
